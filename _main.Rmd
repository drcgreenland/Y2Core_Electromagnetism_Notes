...
```{r echo=FALSE, dipoleMoment, out.width='70%', fig.show='hold', fig.align="center", auto_pdf=TRUE, fig.cap="A diagram of an electric dipole, showing the vector quantities \bf{d} and p, which are the length of the dipole and the dipole moment respectively."}
